   ...
   public function indexs(Request $request): View
    {
        ...
        $data['responsibilities'] = Responsibility::with('keyresult')->where('user_id',$userid)->get();
        return view('user.goal.responsibility.responsibility',$data); 
    }
    ...
    public function create(Request $request): View
    {
        ...
        return view('user.goal.responsibility.create', $data);
    }
    ...
    public function update($id)
    {
        ...
        $data['title'] = 'Add Responsibility';
        $data['sub_title'] = 'Create';
        $data['responsibilty'] = Responsibility::with('keyresult')->find(base64_decode($id));
        // echo "<pre>"; print_r($data['competencies']->toArray()); die;
        return view('user.goal.responsibility.update', $data);
    }
