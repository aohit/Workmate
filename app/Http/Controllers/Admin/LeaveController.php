     ...
     */
     ...
     public function index(): View
        { 
            ...
            $data['sub_title'] = 'Team Leave List';
                ...
                return DataTables::of($data)
                        ...
                        ->addColumn('status', function($row){
                            ...
                            if($row->is_leave == 0){
                                ...
                                $is_leave =  '<span class="badge rounded-pil bg-danger">Rejected</span>';
                            }
                        ...
                        ->addColumn('action', function($row){ 
                            ...
                            // $deleteUrl = route('admin.leave.delete');
        ...
        {  
            ...
            $data['employee_data'] = User::get();  
            $data['leave_type'] = LeaveType::where('status', 1)->get();  
            return view('admin.leave.update',$data); 
        }
        ...
        public function dates(Request $request)
         {
            ...
            $period = new \DatePeriod($startDate, new \DateInterval('P1D'), $endDate);
                ...
                $view =  view('admin.leave.show_date',$data)->render();
