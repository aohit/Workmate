    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($data)
                ...
                ->addColumn('action', function($row){ 
                    ...
                    $editUrl = route('admin.roles.update');
                    $deleteUrl = route('admin.roles.delete');
                    ...
                    $action .=  '<button type="button" onclick="deleteRow(this, \''.$row->id.'\', \''.$deleteUrl.'\')" class="d-none btn-sm btn btn-outline-danger waves-effect waves-light mb-0">Delete</button>';
                    $action .= '</div>';
