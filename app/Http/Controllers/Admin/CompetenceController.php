...
class CompetenceController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $data['sub_title'] = 'View';
        // echo "<pre>"; print_r($data['comptencies']->toArray()); die;
        return view('admin.goal.completece.competencies', $data);
    }
    ...
    public function list(Request $request)
    {
        ...
        if ($request->ajax()) {
            $data = Competencies::with('user')->get();
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $editUrl = route('admin.updatecompetencied', $row->id);
    ...
    public function create(Request $request): View
    {
        ...
        $data['users'] = User::get();
        return view('admin.goal.completece.create', $data);
    }
    ...
    public function update($id)
    {
        ...
        $data['title'] = 'Add Competencies';
        $data['sub_title'] = 'Create';
        $data['competencies'] = Competencies::with('keyresult', 'user')->find($id);
        $data['users'] = User::get();
        // echo "<pre>"; print_r($data['competencies']->toArray()); die;
        return view('admin.goal.completece.update', $data);
    }
