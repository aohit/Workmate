    ...
    public function list(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if(!empty($request->departmentId) && isset($request->departmentId)){
                ...
                $data = GoalReview::with(['user','user.department','Goals','reviewCycle','InputTypesData'])->orderBy('updated_at','DESC')->get(); 
        ...
        // echo "<pre>";print_r($data->toArray());die;
              return DataTables::of($data)
                ...
                ->rawColumns(['employee_id','input_type_id','review_cycle_id','rating_id','departments','job_title','updated_at','action'])
                ->make(true);
    }
    }
