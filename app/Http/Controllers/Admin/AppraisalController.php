...
class AppraisalController extends Controller
{
    ...
    public function list(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = Appraisal::orderBy('updated_at','DESC')->get(); 
            ...
            ->addColumn('name', function($row){
                ...
                ->addColumn('self-review', function($row){
                    ...
                    {
                        $selfReview = '<span class="badge rounded-pill bg-warning">Pending</span>';
                    }else{
                        $selfReview = '<span class= "badge rounded-pill bg-success"> Success </span>';
                    }
                     return $selfReview;
                 })
                 ...
                 ->addColumn('manager-review', function($row){
                    ...
                    {
                        $managerReview = '<span class= "badge rounded-pill bg-warning"> Pending</span>';
                    }else{
                        $managerReview = '<span class= "badge rounded-pill bg-success"> Success </span>';
                    }
                 ...
                 ->addColumn('resultshared', function($row){
                    ...
                    {
                        $resultShared = '<span class= "badge  rounded-pill bg-warning"> Pending responses </span>';
                    }else{
                        $resultShared = '<span class= "badge  rounded-pill bg-success"> Success </span>';
                    }
                    return $resultShared;
                })
                ->addColumn('status', function($row){
                    if($row->status == 0)
                    {
                        ...
                        $status = '<span class= "badge rounded-pill bg-success"> Done </span>';
                    }
                    return $status;
                })
                ...
                ->rawColumns(['name','self-review','deadline','manager','manager-review','manager-deadline','resultshared','status','sno','updated_at','action'])
                ->make(true);
        }
    }
