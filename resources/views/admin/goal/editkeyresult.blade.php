                                ...
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <select class="form-select" id="traking" name="traking" onchange="tracking(this)">
                                        <option value="Milestone" @if ($keyresult->traking == 'Milestone') selected @endif>
                                            Milestone</option>
                                        <option value="Quantiflable traget"
                                            @if ($keyresult->traking == 'Quantiflable traget') selected @endif>Quantiflable traget
                                        </option>
                                    </select>
                                </div>
...
<script>
    function tracking(e) {
        ...
        if (trackingvalue == "Milestone") {
            ...
            $('#startprogress').val("");
            $('#targetprogress').val("");
        } else if (trackingvalue == "Quantiflable traget") {
    ...
    function startprog(e) {
        ...
        $("#targetprogress").attr("min",+startprogess + 1);
    ...
    function targetprog(e) {
        ...
        $("#currentprogress").attr("max",targetprogess);
