                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="progress-container my-2" >
                                    ...
                                    @if ($keyresults->where('goal_id','==',null)->count() > 0)
                                        <span class="badge rounded-pill bg-warning text-dark px-1 me-2">
                                            It contains draft key results progress.
                                        </span>
                                    @endif
                                </div>
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <select class="form-select" name="user">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" @selected($user->id == $goal->user_id)  >{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-lg-4">
                                        ...
                                        <div class="milestone-container ">
                                            ...
                                            <div class="progress-container">
                                                <div class="progress">
                                                    <div class="progress-bar" role="progressbar"
                                                       style="width: {{ number_format($keyresult->total_progress) }}%;"
                                            ...
                                            <div class="milestone-status m-1">
                                                <div class="row">
                                                    ...
                                                    <div class="col text-end">Complete - {{ number_format($keyresult->total_progress) }}%
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
totalresultKey();
        function totalresultKey(){
            ...
            var totaltvalue =  Math.round((totalSum) / (totalkeies));
