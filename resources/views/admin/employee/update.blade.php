                                                ...
                                                <td>
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-lg-3 col-sm-6 py-sm-0 py-2">
                                                            <input type="text" name="emergency_contact_number[]" class="form-control" placeholder="Contact Number" value="{{$emerContect->name}}">
                                                        </div>
                                                       
                                                        <div class="col-lg-3 col-sm-6 my-lg-0 my-sm-3">
