...
<form id="formSubmit" onsubmit="formSubmit(this);return false;">
    ...
    <div class="modal-body">
        <div class="container-fluid">
            <input type="hidden" name="id" value="{{ $reviewcycle->id }}">
            <div class="row">
                <div class="col-lg-12">
                    {{-- <div class="card"> --}}
                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01"
                                        placeholder="Title" name="title" value="{{$reviewcycle->title}}" /> 
                                </div>
                                <div class="mb-3 col-lg-6">
                                    <label for="validationCustom02" class="form-label">Start Date</label>
                                    <input type="date" class="form-control" id="validationCustom02"
                                        placeholder="Start Date" name="start_date" value="{{$reviewcycle->start_date}}"/> 
                                </div>
                                <div class="mb-3 col-lg-6">
                                    <label for="validationCustom03" class="form-label">End Date</label>
                                    <input type="date" class="form-control" id="validationCustom03"
                                        placeholder="End Date" name="end_date" value="{{$reviewcycle->end_date}}"/> 
                                </div>
                                <div class="mb-3 col-lg-6">
                                    <label for="validationCustom02" class="form-label">Status</label>
                                    <select class="form-select" name="status">
                                        <option value="1" @if($reviewcycle->status == 1) selected @endif>Active</option>
                                        <option value="0" @if($reviewcycle->status == 0) selected @endif>In-Active</option>
                                    </select>
                                </div>
                            </div>
