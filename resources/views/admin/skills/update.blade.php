                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="validationCustom04"
                                    placeholder="skills" name="skills" value="{{ $uinfo->skills }}"">
                                
                            </div>  
                        </div> 
                        <div class="row">
                            <div class="mb-3 col-lg-12">
                                <label for="validationCustom04" class="form-label">Experience</label>
                                <input type="text" class="form-control" id="validationCustom04"
                                    placeholder="experience" name="experience" value="{{ $uinfo->experience }}">
