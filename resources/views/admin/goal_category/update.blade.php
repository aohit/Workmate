                            ...
                            <div class="row">
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01"
                                        placeholder="Title" name="title" value="{{$categorye->title}}" /> 
                                </div>
                                <div class="mb-3 col-lg-6">
                                    <label for="validationCustom02" class="form-label">Status</label>
                                    <select class="form-select" name="status">
                                        <option value="1" @if($categorye->status == 1) selected @endif>Active</option>
                                        <option value="0" @if($categorye->status == 0) selected @endif>Deactivate</option>
                                    </select>
                                </div>
                            </div>
