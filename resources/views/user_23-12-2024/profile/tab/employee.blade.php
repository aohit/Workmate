            ...
            <div class="row my-4">
                   ...
                   <div class="col-9 my-2"> 
                    ...
                    <div class="m-0 p-0" style="">{{ ucfirst($uinfo->job_title) }}</div>
                    <div class="my-1">
                    ...
                    <a href=" {{ route('employee_profileedit')}}"  class="btn btn-success"><i class="la-user-edit la"></i>Edit Info</a>
                    <button type="button" onclick=addForm(this);return;false; 
                    class = "btn btn-primary waves-effect waves-light" > <i class="bx bxs-plus-square"></i>Upload Profile Image</button>
                   {{-- <a href="{{ route('add_image') }}" class="btn btn-primary" >
                    <i class="bx bxs-plus-square"></i>Upload Profile Image</a> --}}
                    <a href="javascript:void(0)" onclick="deleteRow(this);" class="btn btn-warning" >
                        <i class="bx bxs-plus-square"></i>Delete Profile Image</a>         
                        {{-- <a href=""  onclick=deleteRow(this);return;false;  class="btn btn-warning" >
                          <i class="bx bxs-plus-square"></i>Delete Profile Image</a>  --}}
                </div>  
            </div>    
