                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-9">
                                        <h4 class="breadcrumb-title"> My Performance Review</h4>
                                    </div>
                                    {{-- <div class="col-3">
                                ...
                                <div class="tab-content py-3">
                                 ...
                                 <div class="row">
                                    <div class="col-9">
                                        <h4 class="breadcrumb-title">Manage Goals</h4>
                                    </div>
                                    <div class="col-3">
                                        {{-- @if (auth('web')->user()->hasPermissionTo('performance'))
                                            {{-- <a href="{{ route('user.appraisal') }}">Go to My Performance</a> --}}
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card" style="background: #fff; w-100">
                            <div class="">
                                <h4 class="breadcrumb-title p-2 mx-2">Company Announcement</h4>
                                        ...
                                        {{-- <div class="row"> --}}
                                            ...
                                            <div class="card w-75 mx-3 overdata">
                                                <div class="card-body" style="background-color: {{ $announcement->background_color_id }}; border-radius:5%;">
                                                    <h4 class="card-title" style="color:{{ $announcement->text_color_id }};">
