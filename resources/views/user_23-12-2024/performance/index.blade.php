        ...
        "autoWidth": true, 
           initComplete: function() {
               $("div.dataTables_length")
                   .html('<button type="button" onclick=addForm(this);return;false; class = "btn btn-outline-primary waves-effect waves-light d-none" > Add </button>');
                   },
       columnDefs: [{
               targets: 0,
               mData: 'employee'
...
function addForm(e) {
   var contentUrl = "{{route('performance.create')}}";
   $.ajax({
       type: "GET",
       url: contentUrl,
