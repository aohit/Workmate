    ...
    <div class="container border mt-4 p-2">
        <div class="milestone-container ">
            ...
            <div class="progress-container">
                <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: {{$keyresult->total_progress }}%;" aria-valuenow="100"
            ...
            <div class="milestone-status m-1">
                <div class="row">
                    ...
                    <div class="col text-end">Complete - {{ $keyresult->total_progress }}%</div>
                </div>
            </div>
        </div>
    </div>
