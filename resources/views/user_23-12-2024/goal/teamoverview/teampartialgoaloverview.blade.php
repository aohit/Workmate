            ...
            <div class="card-body"> 
                <div class="row">
                    <div class="col-12 my-1">
                      <form id="formSubmit" action="{{ route('employee.goaloverview.filter') }}" class="row">
                    <div class="col-3">
                    ...
                    @php 
                     ...
                     @endphp
                    <div class="col-3">
                        <input type="text" class="form-control" id="search-username" name="username" value="{{ $username }}">
                    </div>
                    <div class="col-sm-3">
                ...
                @foreach ($users as $user)
                    <div class="border">
                        <div class="empname p-2">
                            <span>  <img src="{{ asset('assets/images/logo-dark.png') }}" class="rounded-circle" alt="image"
                            ...
                            <div class="col-4 px-3">
                                <div class="row d-flex align-items-center">
                                    <div class="col-4"> {{ $user->totalOfKey }} <br>
                                        Goals </div>
                                    <div class="col-4"> {{ $user->thisWeekDueCount }} <br>
                                        Due This Week </div>
                                    <div class="col-4"> {{ $user->totalDueCount }} <br>
                                        Overdue
                                    </div>
