       ...
       <div class="card h-100">
          <div class="card-body">
                <ul class="nav nav-tabs" id="myTabs" role="tablist">
                   ...
                   <li class="nav-item">
                      <a class="nav-link" id="tab3-tab"   data-tabName ="weges&benefits"  data-target="#tab3" role="tab" aria-controls="tab3" aria-selected="false">Wages & Benefits</a>
                   </li>
                   <li class="nav-item">
...
<script>
  ...
  function loadTabContent(tabname, targetTab) {
    var href = "{{ route('team.profile.tabs') }}";
    $.ajax({
      url: href,
      method: 'POST',
        data: {
