<div class="container mt-2">
    <div class="text-end">
        <a href="{{ route('creatdevelopment',['id' => base64_encode($userid)]) }}" class="btn btn-outline-info waves-effect waves-light">Add</a>
    </div>
    <div class="card mt-2">
                ...
                <div class="card-body py-2">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-end">
                            ...
                            <a href="{{ route('updatedevelopment',base64_encode($comptency->id) ) }}" class="btn btn-light btn-sm"><i
...
<script>
    ...
    function activities(id) {
        $.ajax({
            type: "POST",
            url: "{{ route('admin.developmenthistory') }}",
            data: {
                'id': id
            },
