<div class="container mt-2">
    <div class="text-end">
         <a href="{{ route('creatresponsibility',['id' => base64_encode($userid) ]) }}" class="btn btn-outline-info waves-effect waves-light">Add</a>
    </div>
    <div class="card mt-2" style="box-shadow: none !important; ">
        ...
        @endempty
        @foreach ($responsibilities as $comptency)
            <div class="border">
                <div class="card-body py-2">
                    ...
                    @foreach ($comptency->keyresult as $results)
                        <div class="card border mb-2" style="box-shadow: none !important; ">
                            <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <span class="badge bg-success fs-6 ">{{ $comptency->status }}</span>
                        </div>
                        <div class="col text-end">
                            ...
                            <a href="{{ route('updateresponsibility',base64_encode($comptency->id) ) }}"
...
<script>
    function deletedata(id) {
        ...
        if (confirm("Are You sure want to delete this Row!")) {
            ...
            $.ajax({
                url: "{{ route('destoryresponsibility') }}",
                type: "POST",
                data: {
                    'id': id
                },
