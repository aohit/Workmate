                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <select class="form-select" name="questionnaire">
                                    ...
                                    <option value="{{$questionnaire->id}}" @if($questionnaire->id == $appraisal->questionnaire) selected @endif ><?php  echo ucfirst($questionnaire->title)  ?></option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="mb-3 col-lg-12">
                                ...
                                <select class="form-select" name="reviewcycle">
                                    <option value="">--Choose--</option>
                                    <option value="0"  @if($appraisal->review_cycle == 0) selected @endif >Yearly review</option>
                                    <option value="1"  @if($appraisal->review_cycle == 1) selected @endif >Mid year review</option>
                                </select>
                            </div>
