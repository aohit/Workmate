<div class="card my-2" style="box-shadow: none !important;">

    <p class="d-inline-flex gap-1">
        <button class="btn btn-primary" id="collapsebutton" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample"
