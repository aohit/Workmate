    ...
    <script>
        $(document).ready(function() {
            ...
            window.table = $('#datatable').DataTable({
                ajax: {
                    "url": "{{ route('goal-review.team-list') }}",
                    "type": "POST",
                    "dataType": "json",
                    "data": function(d) {
                ...
                <div class="card-body">
                    <div class="container">
                        <ul class="nav nav-tabs" id="myTabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab1-tab" href="{{ route('allGoalPendingreview') }}"
                                    data-target="#tab1" role="tab" aria-controls="tab1"
                                    aria-selected="true">Pending</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab2-tab"
                                    href="{{ route('allGoalCompletedreview') }}" data-target="#tab2" role="tab"
...
@section('page-js-script')
    ...
    $(document).ready(function() {
        ...
        if (activeTab) {
            $(activeTab).load('{{ route('allGoalPendingreview') }}');
            $(activeTab).addClass('show active');
        } else {
            $('#tab1').load('{{ route('allGoalPendingreview') }}');
