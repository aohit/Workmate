                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-lg-12">
                            <form action="{{ route('leave.file.upload') }}" method="post" class="dropzone"
                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-6">
                                ...
                                <select class="form-select" name="employee_id">
                                    ...
                                    <option value="{{ $employee->id }}" @if($uinfo->employee_id == $employee->id)
                                ...
                                <div class=" col-lg-6"> 
                                    <select class="form-select" name="end_time[]">
                                            ...
                                            <option value="08:30 AM" @if($uinfo->leaveSchedules[0]->end_time == '08:30 AM' && $uinfo->type == '4') selected @endif>08:30 AM</option>
                                                <option value="09:00 AM" @if($uinfo->leaveSchedules[0]->end_time == '09:00 AM' && $uinfo->type == '4') selected @endif>09:00 AM</option>
                                                <option value="09:30 AM" @if($uinfo->leaveSchedules[0]->end_time == '09:30 AM' && $uinfo->type == '4') selected @endif>09:30 AM</option>
                                                <option value="10:00 AM" @if($uinfo->leaveSchedules[0]->end_time == '10:00 AM' && $uinfo->type == '4') selected @endif>10:00 AM</option>
                                                <option value="10:30 AM" @if($uinfo->leaveSchedules[0]->end_time == '10:30 AM' && $uinfo->type == '4') selected @endif>10:30 AM</option>
                                                <option value="11:00 AM" @if($uinfo->leaveSchedules[0]->end_time == '11:00 AM' && $uinfo->type == '4') selected @endif>11:00 AM</option>
                                                <option value="11:30 AM" @if($uinfo->leaveSchedules[0]->end_time == '11:30 AM' && $uinfo->type == '4') selected @endif>11:30 AM</option>
                                                <option value="12:00 PM" @if($uinfo->leaveSchedules[0]->end_time == '12:00 PM' && $uinfo->type == '4') selected @endif>12:00 PM</option>
                                                <option value="12:30 PM" @if($uinfo->leaveSchedules[0]->end_time == '12:30 PM' && $uinfo->type == '4') selected @endif>12:30 PM</option>
                                                <option value="01:00 PM" @if($uinfo->leaveSchedules[0]->end_time == '1:00 PM' && $uinfo->type == '4') selected @endif>01:00 PM</option>
                                                <option value="01:30 PM" @if($uinfo->leaveSchedules[0]->end_time == '1:30 PM' && $uinfo->type == '4') selected @endif>01:30 PM</option>
                                                <option value="02:00 PM" @if($uinfo->leaveSchedules[0]->end_time == '2:00 PM' && $uinfo->type == '4') selected @endif>02:00 PM</option>
                                                <option value="02:30 PM" @if($uinfo->leaveSchedules[0]->end_time == '2:30 PM' && $uinfo->type == '4') selected @endif>02:30 PM</option>
                                                <option value="03:00 PM" @if($uinfo->leaveSchedules[0]->end_time == '3:00 PM' && $uinfo->type == '4') selected @endif>03:00 PM</option>
                                                <option value="03:30 PM" @if($uinfo->leaveSchedules[0]->end_time == '3:30 PM' && $uinfo->type == '4') selected @endif>03:30 PM</option>
                            ...
                            <div class="mb-3 col-lg-12">
                                <a href="{{ route('leave') }}" class="btn btn-light">Close</a>
...
<script type="text/javascript">
    ...
    function removeFile(fileId) {
        if (confirm('Are you sure you want to remove this file?')) {
            var path = "{{ route('leave.file.remove') }}";
            var csrfToken = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                type: 'POST',
                url: path, // Adjust the URL as needed
